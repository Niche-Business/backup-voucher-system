  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: '16px', marginBottom: '40px', maxWidth: '800px', margin: '0 auto 40px' }}>
      ...
      <div style={{ backgroundColor: '#fff', padding: '60px 20px' }}>
        <h2 style={{ textAlign: 'center', fontSize: '32px', marginBottom: '50px', color: '#333' }}>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '24px', marginBottom: '20px', color: '#9C27B0' }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '24px', marginBottom: '20px', color: '#FF9800' }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '24px', marginBottom: '20px', color: '#4CAF50' }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '24px', marginBottom: '20px', color: '#2196F3' }}>
      ...
      <div style={{ backgroundColor: '#f0f7f0', padding: '80px 20px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: '32px', marginBottom: '50px', color: '#2e7d32', fontWeight: 'bold' }}>
          ...
          <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '15px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', marginBottom: '30px' }}>
            <h3 style={{ fontSize: '24px', color: '#2e7d32', marginBottom: '20px', fontWeight: 'bold' }}>{t('landing.about.mission.title')}</h3>
          ...
          {/* Our Vision */}
          <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '15px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', marginBottom: '30px' }}>
            <h3 style={{ fontSize: '24px', color: '#2e7d32', marginBottom: '20px', fontWeight: 'bold' }}>{t('landing.about.vision.title')}</h3>
            <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#555' }}>
          ...
          {/* Our Values */}
          <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '15px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', marginBottom: '30px' }}>
            <h3 style={{ fontSize: '24px', color: '#2e7d32', marginBottom: '25px', fontWeight: 'bold' }}>{t('landing.about.values.title')}</h3>
          ...
          <div style={{ backgroundColor: '#e8f5e9', padding: '40px', borderRadius: '15px', border: '2px solid #4CAF50' }}>
            ...
            <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#333', textAlign: 'center', fontWeight: '500' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{ margin: '0', fontSize: '13px', fontStyle: 'italic' }}>
              BAK UP E-Voucher System v1.1.6
            </p>
          </div>
        </div>
      </div>
