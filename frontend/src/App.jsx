    ...
    <div style={{minHeight: '100vh', backgroundColor: '#f5f5f5'}}>
      ...
      {sidebarOpen && (
        <div style={{
          ...
          <div style={{padding: '10px 20px', marginTop: '10px', textAlign: 'center', fontSize: '0.85em', color: '#666', borderTop: '1px solid #e0e0e0'}}>BAK UP E-Voucher System v1.2.0</div>
        </div>
      )}
    ...
    <div style={{minHeight: '100vh', backgroundColor: '#f5f5f5'}}>
      ...
      {menuOpen && (
        <div style={{
          ...
          <div style={{padding: '10px 20px', textAlign: 'center', fontSize: '0.85em', color: '#666'}}>BAK UP E-Voucher System v1.2.0</div>
        ...
        <div style={{display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap', position: 'relative'}}>
          ...
          {showMenuDropdown && (
            <div style={{
              ...
              <div style={{padding: '10px 20px', borderBottom: '1px solid #eee', textAlign: 'center', fontSize: '0.85em', color: '#666'}}>BAK UP E-Voucher System v1.2.0</div>
        ...
        >
          ...
          >
            ...
            <div style={{padding: '10px', borderTop: '1px solid #eee', fontSize: '0.85em', color: '#666', textAlign: 'center'}}>
              BAK UP E-Voucher System v1.2.0
            </div>
            <button
              onClick={() => {
                setShowMenuDropdown(false)
